...
if __name__ == '__main__':
    ...
    if args.is_training:
        ...
        # print(f"Individual sample data shape: {sample_data.shape}")
        # print(f"Individual sample label: {sample_label} (not a tensor, so no shape attribute directly, but if converted: {torch.tensor(sample_label).shape})")
